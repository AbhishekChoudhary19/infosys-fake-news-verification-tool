[README.md](https://github.com/user-attachments/files/25046102/README.md)
# TruthGuard
...
TruthGuard is an AI-powered fake news detection system developed under the Infosys Springboard 6.0 Internship. This web-based platform utilizes advanced artificial intelligence and machine learning techniques to verify the credibility of news articles and online content in real time.

In response to the growing spread of misinformation across social media and digital news platforms, TruthGuard analyzes textual content to identify misleading patterns and assess authenticity. It classifies information as Reliable, Suspicious, or Fake, providing confidence scores to support informed decision-making.
...
```bash
git clone https://github.com/AbhishekChoudhary19/infosys-fake-news-verification-tool
...
- Email: abhichou2003@gmail.com
- GitHub: [@AbhishekChoudhary19](https://github.com/AbhishekChoudhary19)
  

**Project Link**: [Fake-News-Detection-verification-Tool](https://github.com/AbhishekChoudhary19/infosys-fake-news-verification-tool/)
